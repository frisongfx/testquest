...
def export_results(prova, qtdQuest):
    ...
    arquivo_geral = pd.read_excel(r'C:\Users\lab10\Desktop\testquest\excel_export\Banco_Geral.xlsx')
    arquivo_lista = pd.read_excel(r'C:\Users\lab10\Desktop\testquest\excel_export\Banco_Lista.xlsx')
    arquivo_por_quest = pd.read_excel(r'C:\Users\lab10\Desktop\testquest\excel_export\Banco_TF.xlsx')
    ...
    arquivo_geral.to_excel('C:\\Users\\lab10\\Desktop\\testquest\\excel_export\\Banco_Geral.xlsx', index=False)
    arquivo_por_quest.to_excel('C:\\Users\\lab10\\Desktop\\testquest\\excel_export\\Banco_TF.xlsx', index=False)
